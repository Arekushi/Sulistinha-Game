...
public class TelaPrincipal extends JFrame {
	...
	private void init() {
		...
		//Progress Bar
		pbTempoResposta = new MyProgressBar(0, 100, areaQuestao.getWidth()/100*50, 20, Cores.corVerde, Color.BLACK, 3);
...
//			new TelaFim(null);
	...
	public static synchronized TelaPrincipal getInstance() {
		...
		return (INSTANCE == null)? INSTANCE = new TelaPrincipal(): INSTANCE;
	}
